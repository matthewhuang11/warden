...
For a quick local demonstration that does not contact any model or API, run:

```bash
npm run demo
```

That script obfuscates one synthetic TypeScript snippet and shows how a mocked
model response is rehydrated back to the original names.
